...
# Finally if Equation = "0" The program prints the solution ELSE if Equation = "1" it will go through each order while providing the error percentage after each order 
